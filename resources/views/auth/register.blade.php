        ...
        <div class="sec2-2">
            ...
            <div class="sec2-2-2">
                ...
                <div>
                    ...
                    <input name="username" type="text" class="sec2-2-2-input @error('username') is-invalid @enderror" id="username" placeholder="Username" value="{{ old('username') }}" required autocomplete="username" autofocus >
                            @error('username')
                    ...
                    <input name="dob" type="text" class="form-control sec2-2-2-input" onfocus="(this.type='date')"id="validationDefault11" placeholder="Date of Birth" required>
                    <p>Password</p>
                    <div class="last">
                        <div>
                            <!-- <input type="password" class="sec2-2-2-i" placeholder="Password*" id="myinput"> -->
                            <input id="password" type="password" class="form-control sec2-2-2-input @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                    ...
                    <div class="last">
                        <div>
                            ...
                            <input id="password-confirm" type="password" class="form-control sec2-2-2-input"  name="password_confirmation" required autocomplete="new-password">
                        </div>
                        <div>
                            <input type="checkbox" onclick="Myfunction()" class="cek">
                        </div>
